...
describe('Store Config', () => {
  ...
  describe('cfg object', () => {
    it('should have all expected properties', () => {
      const expectedProps = [
        'wenny', 'texty', 'pinny', 'liney', 'gendy', 'turny', 'navvy', 'beeny',
        'baguy', 'drawer', 'threedy', 'loading', 'perused', 'metafied', 'journaled',
        'consulted', 'configured', 'thanked', 'fedback', 'emailVerified', 'phoneVerified'
      ];
